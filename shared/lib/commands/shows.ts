import { db, Show, Performance } from '../db';
import { shows, performances, showTags } from '../db/schema';
import { eq } from 'drizzle-orm';
import { filterDefinedFields } from '../utils/filterDefinedFields';
import { generateUniqueSlug, ensureSlug } from '../utils/slug';
import { getShowBySlug, getPerformanceById } from '../queries/shows';
