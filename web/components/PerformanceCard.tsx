...
import { ShowWithTagsAndPerformances, Tag } from '@ons-mierloos-theater/shared/db';
...
export default function PerformanceCard({ show, href }: PerformanceCardProps) {
  ...
  return (
    <Link href={href || `/voorstellingen/${slug}`} className="group w-full max-w-lg cursor-pointer">
