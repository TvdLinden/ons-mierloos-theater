...
import { User, UserRole } from '@ons-mierloos-theater/shared/db';
  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials) {
        ...
        const { updateUser } = await import('@ons-mierloos-theater/shared/commands/users');
...
export async function validateResetToken(token: string) {
  ...
  const { db } = await import('@ons-mierloos-theater/shared/db');
  const { users } = await import('@ons-mierloos-theater/shared/db/schema');
