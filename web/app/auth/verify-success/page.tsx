  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-surface rounded-lg shadow-lg">
      <div className="text-center mb-6">
        ...
        <h1 className="text-2xl font-bold mb-2 text-success">E-mail geverifieerd!</h1>
      </div>

      <div className="space-y-4 text-text-secondary">
        <p>Je e-mailadres is succesvol geverifieerd. Je kunt nu inloggen op je account.</p>

        <div className="bg-success/10 border-l-4 border-success p-4 rounded">
          <p className="text-sm text-success">
            <strong>Gelukt!</strong> Je account is nu actief en je kunt alle functies gebruiken.
          </p>
        </div>
      </div>
